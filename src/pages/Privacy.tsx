...
const sections = [
  ...
  },
  {
    ...
    body: "We use local storage to save your theme and language preferences. No third-party tracking cookies are used on Facelook.",
  },
  {
    title: "User Control",
    body: "You can lock or hide your profile at any time through the Settings menu. You are always in control of your visibility and privacy on Facelook.",
  },
];
