...
const LoginScreen = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#020617] flex flex-col items-center justify-between px-6 py-12 relative overflow-hidden">
      {/* Ambient glow orbs */}
      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-xs z-10">
        ...
        <div style={{ perspective: "600px" }}>
          <motion.div
            ...
            className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-blue-500 via-blue-600 to-purple-700 flex items-center justify-center shadow-2xl shadow-blue-500/40 border border-white/10"
          >
            <span
        ...
        <div className="text-center space-y-2">
          ...
          <motion.p
            ...
            className="text-sm text-white/40 font-medium leading-relaxed max-w-[220px] mx-auto"
          >
            Connect the Unconnected,{" "}
            <span className="text-white/60">Discover the Real You.</span>
          </motion.p>
        </div>
        ...
        >
          <button
            ...
            disabled={loading}
            className="w-full h-14 bg-white hover:bg-white/90 active:scale-95 transition-all rounded-2xl flex items-center justify-center gap-3 shadow-xl shadow-black/20 font-black text-sm text-slate-800 border border-white/20 disabled:opacity-60"
          >
            {loading ? (
        ...
        <motion.p
          ...
          className="text-[10px] text-white/20 text-center leading-relaxed font-medium"
        >
          By continuing, you agree to Facelook's{" "}
          <a href="/privacy" className="text-blue-400/60 underline underline-offset-2">
            Privacy Policy
          </a>
        </motion.p>
      </div>
